    ...
    <section className="relative w-full min-h-[80vh] flex flex-col items-center justify-center pt-32 pb-20 px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <a
          ...
          className="group relative inline-flex items-center gap-4 bg-text-primary text-bg-primary px-10 py-5 rounded-full text-xl font-medium overflow-hidden"
          data-cursor="view"
        >
          <span className="relative z-10">Say Hello</span>
          <ArrowUpRight className="relative z-10 group-hover:rotate-45 transition-transform duration-300" size={24} />
          <div className="absolute inset-0 bg-mint translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out" />
        </a>
      </div>
    </section>
  );
